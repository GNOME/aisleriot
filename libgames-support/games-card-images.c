...
static void
games_card_images_render (GamesCardImages * images, gint cardid)
{
  int sx, sy;
  GdkPixbuf *subpixbuf;
...
static void
games_card_images_prerender (GamesCardImages * images)
{
  gchar *fullname;
...
static void
games_card_images_purge (GamesCardImages * images)
{
  int i;
...
GdkPixbuf *
games_card_images_get_card_by_id (GamesCardImages * images, gint cardid)
{
...
GdkPixbuf *
games_card_images_get_card (GamesCardImages * images, gint suit, gint rank)
{
  ...
  return games_card_images_get_card_by_id (images,
					   GAMES_CARD_ID (suit, rank));
}

GdkPixbuf *
games_card_images_get_back (GamesCardImages * images)
{
  return games_card_images_get_card_by_id (images, GAMES_CARD_BACK);
}

GdkPixbuf *
games_card_images_get_red_joker (GamesCardImages * images)
{
  return games_card_images_get_card_by_id (images, GAMES_CARD_RED_JOKER);
}

GdkPixbuf *
games_card_images_get_black_joker (GamesCardImages * images)
{
  return games_card_images_get_card_by_id (images, GAMES_CARD_BLACK_JOKER);
}

void
games_card_images_set_size (GamesCardImages * images, gint width, gint height)
{
...
void
games_card_images_set_theme (GamesCardImages * images, gchar * name)
{
...
static void
games_card_images_init (GamesCardImages * cardimages)
{
