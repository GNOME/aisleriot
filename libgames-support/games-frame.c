...
static void      games_frame_child_allocate      (GtkFrame       *frame,
                                                 GtkAllocation  *allocation);
static void      games_frame_style_set           (GtkWidget      *widget,
                                                 GtkStyle       *previous);
...
games_frame_init (GamesFrame *frame)
{
  g_signal_connect (frame, "notify::label-widget",
                    G_CALLBACK (games_frame_label_widget_notify),
                    NULL);
}

static void
games_frame_size_request (GtkWidget      *widget,
                         GtkRequisition *requisition)
{
...
static void
games_frame_size_allocate (GtkWidget     *widget,
                          GtkAllocation *allocation)
{
  GtkFrame *frame = GTK_FRAME (widget);
  GtkBin   *bin   = GTK_BIN (widget);
...
static void
games_frame_style_set (GtkWidget *widget,
                      GtkStyle  *previous)
{
...
static gboolean
games_frame_expose_event (GtkWidget      *widget,
                         GdkEventExpose *event)
{
...
games_frame_new (const gchar *label)
{
  ...
  frame = g_object_new (GAMES_TYPE_FRAME,
                        "label", label,
                        NULL);
