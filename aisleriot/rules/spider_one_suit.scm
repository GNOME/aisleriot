...
; create a deck of 104 cards (made up of eight decks of just spades)
...
(define (make-onesuit-octuple-deck)
  (if (= ace 14)
      (set! DECK (append (make-standard-deck-list-ace-high 2 spade) (make-standard-deck-list-ace-high 2 spade) (make-standard-deck-list-ace-high 2 spade) (make-standard-deck-list-ace-high 2 spade) (make-standard-deck-list-ace-high 2 spade) (make-standard-deck-list-ace-high 2 spade) (make-standard-deck-list-ace-high 2 spade) (make-standard-deck-list-ace-high 2 spade)))
      (set! DECK (append (make-standard-deck-list-ace-low ace spade) (make-standard-deck-list-ace-low ace spade) (make-standard-deck-list-ace-low ace spade) (make-standard-deck-list-ace-low ace spade) (make-standard-deck-list-ace-low ace spade) (make-standard-deck-list-ace-low ace spade) (make-standard-deck-list-ace-low ace spade) (make-standard-deck-list-ace-low ace spade)))))

(define (new-game)
  (initialize-playing-area)
  (make-onesuit-octuple-deck)
  (shuffle-deck)
